...
$SUR_CATKIN_WS_PATH/ardupilot/Tools/autotest/sim_vehicle.py \
    -v ArduCopter \
	-f gazebo-iris \
	-m '--daemon --streamrate=30 --console --no-state --mav20 --out=udp:127.0.0.1:14551' -I0" &
...
roslaunch demo gazebo.launch world_name:="$SUR_CATKIN_WS_PATH/ardupilot_gazebo/worlds/test.world" &
sleep $TIME_TO_SLEEP
